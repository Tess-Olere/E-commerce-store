  ...
  return (
    <Container>
      ...
      <div style={{marginTop: '5rem'}}>
                <h6 className='text-start font-bold'>Similar items</h6>
                <div className='mt-5 d-flex overflow-auto gap-4 w-100'>
                  {filterById.map((item)=> (
                    <div className='flex-shrink-0' key={item.id}>
                      ...
                      <p className='text-black mb-0 text-sm'>{FormatCurrency(item.title)}</p>
                      <Button variant='outline-dark' className='border-none border-0' onClick={()=> { 
